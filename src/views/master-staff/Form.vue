                        ...
                        <div class="row">
                            <div class="col-12 mt-3">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Form Data Petugas</h4>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                    ...
                                    <div class="card custom-rounded-medium">
                                        ...
                                        <div class="card-footer card-footer-custom-radius-medium">
                                            <div class="d-flex justify-content-end">
                                                <router-link to="/master-staff" class="btn border-light bg-white custom-rounded-medium me-2">Kembali</router-link>
    ...
    methods: {
        ...
        async saveUser(uid) {
            try {
                ...
                this.$toast.success('Data Petugas Berhasil Disimpan');
            } catch(error) {                
