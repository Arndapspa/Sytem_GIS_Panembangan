            ...
            <div class="main-content">
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12 mt-3">
                                <div class="page-title-box d-sm-flex align-items-start justify-content-between">
                                    <h4 class="mb-sm-0">Data Petugas</h4>
                                    <div class="d-flex">
                                        ...
                                        <router-link to="/master-staff/form" class="btn btn-primary button-rounded ms-2" type="button"><i class="mdi mdi-plus me-1"></i>Tambah Baru</router-link>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p>Menampilkan {{pagination.total}} data petugas</p>
                                        ...
                                        <tbody>
                                            <template v-if="pagination.total > 0">
                                                <tr v-for="item in listPaged">
                                                    ...
                                                    <td class="middle-item">{{ item.address }}</td>
                                                    ...
                                                    <td class="middle-item">
                                                        <div class="d-flex justify-content-end align-items-center">
                                                            <router-link :to="`master-staff/form/${item.id}`" class="btn btn-square border bg-white me-2"><i class="mdi mdi-circle-edit-outline fs-4"></i></router-link>
    ...
    methods: {
        ...
        async fetchData() {
            ...
            try {
                ...
                .filter(data => {
                    return data.name.toUpperCase().includes(this.keywords.toUpperCase());
                });
